...
class AdvancedTranslateUI:
    ...
    def create_sidebar(self):
        ...
        self.functions = {
            ...
            "清除本地配置文件": self.show_clean_frame,
    ...
    def create_clean_frame(self, parent):
        # 清除配置界面
        ttk.Label(parent, text="清除本地配置文件", font=('TkDefaultFont', 12, 'bold')).pack(pady=10)
        
        ttk.Label(parent, text="这将清除所有本地配置和缓存文件").pack(pady=5)
    ...
    def clean_config(self):
        ...
        if result:
            self.log("清除本地配置文件...")
            path_config=os.getenv('LOCALAPPDATA')+r'ProjectMoon\LimbusCompany\synchronous-data_product.json'
