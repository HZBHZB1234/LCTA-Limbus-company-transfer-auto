...
from webutils.const_apiConfig import (
    LLM_TRANSLATOR, TKIT_MACHINE, TKIT_MACHINE_OBJECT, format_api_settings
)
...
'''
    ...
    def test_api(self, key: str, api_settings: dict) -> dict:
        ...
        try:
            ...
            import _lcta_native
            from translateFunc.native_pipeline import build_native_provider

            formatted = format_api_settings(key, api_settings)
            provider = build_native_provider(key, formatted)
            result_dict = json.loads(
                _lcta_native.test_provider(
