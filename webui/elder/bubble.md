...
气泡文本让每个人格在游戏中说话时显示专属的对话文本，极大提升游戏沉浸感。基于游戏本地化文本机制实现。
...
<div class="elder-warning-card">
    ...
    <p>气泡文本是直接安装在汉化包上的。<strong>每次切换或更新汉化包后都需要重新安装气泡文本。</strong>如果你在「Launcher配置」页启用了「启用气泡文本」，启动器会在每次更新后自动安装，无需担心。</p>
</div>
