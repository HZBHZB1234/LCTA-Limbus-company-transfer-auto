...
class ConfigManager {
    constructor() {
        ...
        this.configKeyMap = {
            ...
            "file-concurrency": "ui_default.translator.file_concurrency",
            "request-concurrency": "ui_default.translator.request_concurrency",
            "file-io-concurrency": "ui_default.translator.file_io_concurrency",
